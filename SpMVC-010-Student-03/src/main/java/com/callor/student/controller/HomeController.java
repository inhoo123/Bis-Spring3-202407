...
public class HomeController {
	...
	public HomeController(StudentDao studentDao, StudentDao studentService) {
		super();
		this.studentDao = studentDao;
		this.studentService = studentService;/// ?안함
	}
	...
	public String stNumCheck(String st_num) {
		/*
		 * findByID() method 는 PK를 기준으로 SELECT 하여 그결과를 return 한다 만약 id 에 해당하는 데이터가 있으면 그
		 * 데이터를 return 하고 없으면 null 값을 return 한다
		 */
