...
public String	METRO_FLAG;//	광역 노선 구분	2	1	0
...
public String	ENG_BUSSTOP_NAME;//	현재 정류소 위치 (영문)	60	1	GwangjuStation
public String	Overpass;//
public String	ARRIVE_FLAG;//	곧도착 FLAG	2	1	0
public String	LINE_KIND;//	노선 구분	2	1	0
}
